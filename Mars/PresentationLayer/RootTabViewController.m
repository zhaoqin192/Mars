...
- (void)viewDidLoad {
    ...
    [self setupOneChildViewController:[[XMGNavigationController alloc] initWithRootViewController:[[UIViewController alloc] init]] title:@"计划" image:@"计划_1" selectedImage:@"计划_2"];
