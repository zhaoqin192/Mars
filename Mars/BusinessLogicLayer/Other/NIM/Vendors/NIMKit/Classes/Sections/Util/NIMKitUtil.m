...
+ (NSString *)chatroomNotificationFormatedMessage:(NIMMessage *)message{
    ...
    switch (content.eventType) {
        ...
        {
            return [NSString stringWithFormat:@"欢迎%@进入会议",targetText];
        }
        ...
        {
            return [NSString stringWithFormat:@"%@被解除会议成员身份",targetText];
        }
        case NIMChatroomEventTypeAddCommon:
        {
            return [NSString stringWithFormat:@"%@被添加为会议成员身份",targetText];
        }
        case NIMChatroomEventTypeInfoUpdated:
        {
            return [NSString stringWithFormat:@"会议公告已更新"];
        }
        case NIMChatroomEventTypeKicked:
        {
            return [NSString stringWithFormat:@"%@被管理员移出会议",targetText];
        }
        case NIMChatroomEventTypeExit:
        {
            return [NSString stringWithFormat:@"%@离开了会议",targetText];
        }
        case NIMChatroomEventTypeClosed:
        {
            return [NSString stringWithFormat:@"会议已关闭"];
        }
        default:
            break;
    }
